CREATE DATABASE  IF NOT EXISTS `dalf_store_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dalf_store_db`;
...
CREATE TABLE `orders` (
  ...
  KEY `userId` (`userId`),
  KEY `stateId` (`stateId`),
  KEY `payRoleId` (`payRoleId`),
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`id`),
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`stateId`) REFERENCES `states` (`id`),
  CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`payRoleId`) REFERENCES `payroles` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `products` (
  ...
  CONSTRAINT `products_ibfk_3` FOREIGN KEY (`brandId`) REFERENCES `brands` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-10-19  1:32:39
